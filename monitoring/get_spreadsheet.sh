...
echo "TILE_NO,ANT_NO,POP_GRID_REF,LNA_SN,SMART_BOX_PORT,FIBRE_TAIL_NO,FEM_NO,FIBRE_CABLE_LEN,FNDH_FOBOT_PORT,ORIG_ORDER_OF_SDGI_CABLE,CFNDH_Bldg_Fibre_info,Bldg_Fibre_Colour,TPM_Location,TPM_Position,TPM_SN,TPM_IP,TPM_PORT_NO,WEBPAGE_PLOT_NO,MIRIAD_IDX,LNA_SN,Permanent_Comments,NULL1,NULL2,NULL3,NULL4,NULL5,NULL6,NULL7,NULL8,NULL9,NULL10,NULL11,NULL12,NULL13,NULL14,NULL15,NULL16,NULL17,NULL18" > header.txt
