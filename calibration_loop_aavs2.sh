...
echo "python ~/aavs-calibration/calibration_loop.py --config=/opt/aavs/config/aavs2.yml -i enp216s0f0 -d /data/real_time_calibration/ ${options}"
python ~/aavs-calibration/calibration_loop.py --config=/opt/aavs/config/aavs2.yml -i enp216s0f0 -d /data/real_time_calibration/ ${options}

echo "post_calibration_actions.sh AAVS2"
post_calibration_actions.sh AAVS2 
