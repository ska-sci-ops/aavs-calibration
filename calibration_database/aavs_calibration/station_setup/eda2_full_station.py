...
# Sheet url
url = r"https://docs.google.com/spreadsheets/d/e/2PACX-1vQqOhkIgUBtIHBFOVRd34potpDGND7mIQ66hF97f4zwoMt30Jgko5tdNer_Ts" \
      r"WOPZgYooA0UjR2KhrB/pub?gid=1156216434&single=true&output=tsv"
    ...
    for tpm in tpm_order:
        ...
        for i in range(1, len(html)):
            ...
            if items[13] != '-' and int(items[13]) == tpm:
                ...
                antenna_information.append({'base': base, 'tpm': tpm, 'rx': rx, 'east': east, 'north': north, 'up': up})
